...
<nav class="navbar navbar-light shadow px-4"
	style="height: 90px; position: relative; z-index: 1000;">
	<div
		class="container-fluid position-relative d-flex justify-content-between align-items-center">

		<!-- 왼쪽: 햄버거 버튼 + 검색 -->
		<div class="d-flex align-items-center flex-grow-1"
			style="min-width: 0; position: relative;">
			<!-- 햄버거 버튼: 항상 보이게 -->
			<button class="navbar-toggler d-block border-0 me-2" type="button"
			...
			<form action="index.jsp" method="get"
				...
				<input type="text" id="searchInput" name="keyword"
					...
					placeholder="관광지 검색" style="font-size: 0.9rem;">
				...
				<!-- 자동완성 추천 목록 -->
				<ul id="suggestions"
					style="border: 1px solid #ccc; display: none; position: absolute; top: 110%; left: 0; right: 0; background: white; list-style: none; margin: 0; padding: 0; max-height: 200px; overflow-y: auto; z-index: 9999; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
				</ul>
			</form>
		</div>
		...
		<div class="position-absolute top-50 start-50 translate-middle">
			<a class="navbar-brand" href="index.jsp"> <img
				src="./image/tripful_logo.png" alt="Tripful Logo"
				style="height: 110px;">
			</a>
		</div>
		...
		<div class="d-flex align-items-center gap-2 flex-shrink-0">
			...
			<button class="btn btn-sm btn-outline-warning"
				onclick="location.href='index.jsp?main=login/login.jsp'">Login</button>
			<%
			} else {
			%>
			<span class="me-2 d-none d-md-inline"><strong><%=name%></strong>님
				환영합니다!</span>
	...
	<div class="collapse" id="mainMenu"
		style="position: absolute; top: 90px; left: 0; width: 100%; background-color: white; z-index: 1050;">
		<ul class="navbar-nav px-4 py-3">
			<li class="nav-item"><a class="nav-link"
				href="index.jsp?main=/place/selectPlace.jsp">지역별 관광지</a></li>
			<li class="nav-item"><a class="nav-link"
				href="index.jsp?main=board/boardList.jsp&sub=event.jsp">이벤트</a></li>
			<li class="nav-item"><a class="nav-link"
				href="index.jsp?main=board/boardList.jsp&sub=notice.jsp">공지사항</a></li>
			<li class="nav-item"><a class="nav-link"
				href="index.jsp?main=board/boardList.jsp&sub=support.jsp">QnA
					게시판</a></li>
		</ul>
	</div>
</nav>
